...
export const websites: Website[] = [
  ...
  },
  {
    slug: "cloudbill",
    title: "CloudBill",
    description: "AI cloud bill copilot",
    mockup: {
      src: "/images/websites/cloudbill/mockup.jpg",
      alt: "CloudBill FinOps landing page with cloud cost dashboard and KPI cards",
      width: 1600,
      height: 900,
      cardBackground: "#F4F8FF",
    },
    url: "https://studio.hammedshotola.com/cloudbill",
    status: "live",
    order: 10,
  },
];
