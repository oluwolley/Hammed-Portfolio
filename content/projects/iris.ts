...
export const irisProject: Project = {
  ...
  seo: {
    title: "IRIS - Streamlining back-office tools",
    description:
      "IRIS - Streamline the Customer support tools to reduce the resolution time - CMS | Web application",
  },
  sections: [
    {
      id: "background",
    ...
    },
    {
      ...
      kind: "finalUi",
      title: "App Review",
      content: "App Review: IOS and Android review, reply app store comment.",
      images: [
        {
